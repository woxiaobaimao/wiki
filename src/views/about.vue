    ...
    <a-layout-content :style="{ background: '#fff', padding: '24px', margin: 0, minHeight: '280px' }">
      <div class="about">
        ...
        <div>
          <b
            >免费课程：
            <a href="https://www.imooc.com/learn/1160" target="_blank"> 《开发工具IDEA从入门到爱不释手》 </a>
          </b>
        </div>
        <br />
        <div>
          <b
            >QQ：82144921，<span style="color: rgb(194, 79, 74)">阿里云产品使用咨询、购买优惠</span
            >，加QQ，备注：阿里云</b
          >
        </div>
        ...
        <div>
          <b>个人全栈技术博客： <a href="http://www.jiawablog.com" target="_blank">甲蛙博客</a></b>
        </div>
